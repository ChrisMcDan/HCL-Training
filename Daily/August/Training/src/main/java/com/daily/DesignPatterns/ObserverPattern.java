...
package com.daily.DesignPatterns;

import java.util.ArrayList;
import java.util.List;

/* one-to-one dependency -> when one object changes the state all other dependent objs
 ...
 * publish subscribe
 * has their own messaging servers-> publishing a new movie and configuring it to those
